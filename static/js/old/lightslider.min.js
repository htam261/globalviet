    ...
    a.fn.lightSlider = function (b) {
        ...
        return z.chbreakpoint = function () {
            ...
            d = {
                doCss: function () {
                    var a = function () {
                        for (var a = [
                            ...
                            'msTransition',
                            'KhtmlTransition'
                        ], b = document.documentElement, c = 0; c < a.length; c++) if (a[c] in b.style) return !0
                    };
                ...
                initialStyle: function () {
                    ...
                    this.doCss() && p.addClass('usingCss'),
                        z.calL(),
                        'slide' === e.mode ? (z.calSW(), z.sSW(), e.loop === !0 && (t = a.slideValue(), this.move(g, t)), e.vertical === !1 && this.setHeight(g, !1))  : (this.setHeight(g, !0), g.addClass('lSFade'), this.doCss() || h.not('.active').css('display', 'none')),
                ...
                pager: function () {
                    ...
                    if (z.createPager = function () {
                            ...
                            e.gallery === !0 && (e.vertical === !0 && k.find('.lSPager').css('width', e.vThumbWidth + 'px'), u = d * (e.thumbMargin + w) + 0.5, k.find('.lSPager').css({
                                property: u + 'px',
                ...
                setHeight: function (a, b) {
                    ...
                    f(),
                        c.has('img') ? c.find('img').load(function () {
                            setTimeout(function () {
                                f(),
                                x || d.auto()
                            }, 100)
                ...
                build: function () {
                    var a = this;
                    a.initialStyle(),
                    this.doCss() && (e.enableTouch === !0 && a.enableTouch(), e.enableDrag === !0 && a.enableDrag()),
                        a.pager(),
                        a.controls(),
                        a.keyPress()
                }
            ...
            z.init = function () {
                ...
                e.adaptiveHeight === !1 && ('slide' === e.mode ? e.vertical === !1 && d.setHeight(g, !1)  : d.setHeight(g, !0)),
