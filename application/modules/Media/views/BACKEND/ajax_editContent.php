	...
	<div class="row_text_field">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				...
				<td class="right_text_field"><input type="file" name="fileAdmincp[thumbnail]" /><?php if(isset($result->image)){ if($result->image!=''){ ?> - <a class="fancyboxClick" href="<?=PATH_URL.DIR_UPLOAD_SLIDER.$result->image?>">Review</a><?php }} ?></td>
			</tr>
		</table>
	</div>
        <div class="row_text_field">
                    ...
                    <td class="right_text_field">
                        <select name="positionAdmincp" id="positionAdmincp">
                            <?php
                                ...
                                {                            ?>
                            <option <?php if(isset($result->position)) if($result->position == $postion->id) print "selected=\"selected\"";?> value="<?= $postion->id?>"><?=$postion->Name ?></option>
                            <?php } ?>
                        </select>
                    </td>
                </tr>
