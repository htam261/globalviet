<div class="content_table">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<th width="150" class="th_left th_no_cursor">Thumbmail</th>
			<th class="th_left" onclick="sort('title')"><div id="title" class="sort icon_no_sort">Name</div></th>
            <th width="70"><div id="position" class="icon_no_sort">Position</div></th>
			<th width="70" onclick="sort('active')"><div id="active" class="sort icon_no_sort">Active</div></th>
		...
		<tr class="item_row<?=$i?> <?php ($k%2==0) ? print 'row1' : print 'row2' ?>">
			...
			<td class="td_center"><img class="img_block" alt="" src="<?=resizeImage(PATH_URL.DIR_UPLOAD_SLIDER.$v->image,150)?>" /></td>
			<td class="th_left"><a href="<?=PATH_URL.'admincp/'.$module.'/update/'.$v->id?>"><?=$v->name?></a></td>
            <td class="th_left"><?=$this->model->getPositionName($v->position)?></td>
