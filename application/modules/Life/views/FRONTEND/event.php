            ...
            <div class="row padding-left-right-0">
                <div class="col-sm-6 col-md-12 color-black">
                    ...
                    <div class="col-lg-12 padding-top-bottom-10 padding-left-0">
                        ...
                        ?>
                        <!--<p class="categoryselectd"><i class="glyphicon-ico-dotselted"></i><font > Sản phẩm thương mại</font></p>
                        <p class=""><i class="glyphicon-ico-dot "></i><font color=""> Sản phẩm thương mại</font></p>
                        <p class=""><i class="glyphicon-ico-dot "></i><font color=""> Sản phẩm thương mại</font></p>
                        <p class=""><i class="glyphicon-ico-dot "></i><font color=""> Sản phẩm thương mại</font></p>
                        -->
                    </div>
                ...
                if($items){
                    foreach ($items as $item): ?>
                        <div class="col-md-12  padding-top-bottom-5">
                            <div class="media padding-top-bottom-15">
                                ...
                                <div class="media-body padding-left-20">
                                    <h4 title="<?=stripslashes($item->title)?>" class="media-heading">
                                        <a href="<?= site_url('event/detail/' . $item->alias) ?>.html"> <?=stripslashes($item->title)?> </a>
                                    </h4>
                                    <p>
