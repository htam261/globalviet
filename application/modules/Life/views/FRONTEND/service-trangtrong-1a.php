                    ...
                    <div class="col-md-12 padding-right-0">
                        <div class="row seractive">
                            ...
                            <div class="col-md-6 padding-left-right-0">
                                <div class="col-md-12 padding-left-right-0 uload">
                                    <img id="zoom_02" data-zoom-image="<?=img(DIR_UPLOAD_NEWS . $result->thumbnail,1280,800)?>"
                                         src="<?=img(DIR_UPLOAD_NEWS . $result->thumbnail,416,229)?>"
                                         class="img-responsive" alt="..."
                                         style="height: 229px; width:416px;"
                                    />
                                </div>
                                <div class="col-md-12 silder padding-left-right-0" style="padding-top: 15px;">
                                    <style>
                                        #myCarouselsmall .carousel-control {
                                            /*left: -27px;*/
                                            font-size: 30px;
                                            line-height: 15px;
                                            border-radius: 11px;
                                        ...
                                        #myCarouselsmall  .left{ left: -2px;}
                                        #myCarouselsmall .right {
                                            right: 30px;
                                            left: auto;
                                        }
                                        #myCarouselsmall .seractive .active {
                                            background-color: rgba(255, 255, 255, 0);
                                        }
                                        #myCarouselsmall .active {
                                            background-color: rgba(0, 0, 0, 0);
                                        }
                                    </style>
                                <!----smail slider---->
                                    <div class="carousel slide padding-bottom-0" id="myCarouselsmall" style="padding-bottom: 0px; padding-right: 80px;">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="item active">
                                                <div class="row-fluid">
                                                    <? $items = $servicesimg["list_article"];
                                                    if($items){
                                                        foreach ($items as $item): ?>
                                                            <div class="col-md-4 padding-left-right-0">
                                                                <? if($item->col==1){?>
                                                                    <img data-zoom-image="<?=img(DIR_UPLOAD_NEWS . $item->thumbnail,1280,800)?>"
                                                                            src="<?=img(DIR_UPLOAD_NEWS . $item->thumbnail,416,229)?>"
                                                                            class="img-responsive current" alt="..." width="109" height="82" style="width: 109px; height: 82px;"/>

                                                                <? }else{?>
                                                                    <img data-zoom-image="<?=img(DIR_UPLOAD_SLIDER . $item->thumbnail,1280,800)?>"
                                                                            src="<?=img(DIR_UPLOAD_SLIDER . $item->thumbnail,416,229)?>"
                                                                            class="img-responsive current" alt="..." width="109" height="82" style="width: 109px; height: 82px;"/>
                                        ...
                                        <a data-slide="prev" href="#myCarouselsmall" class="left carousel-control">‹</a>
                                        <a data-slide="next" href="#myCarouselsmall" class="right carousel-control">›</a>
                                    </div><!--/myCarousel-->
                                <!--end smail slider------>
...
-->
        ...
        <div class="col-md-12">
            <div class="container silder">
                ...
                <div class="row">
                    <div class="span12">
                        <div class="slidermycarouseldetail">
                                                    ...
                                                    <div class="span3">
                                                        <div class="col-md-12 padding-left-0">
                                                            <div class="thumbnail active">
                                                                ...
                                                                <div class="caption">
                                                                    <!--border-bottom: 2px solid darkgray; color: green-->
                                                                    <!--style="border-bottom: 2px solid darkgray; color: green; height: 34px; white-space: normal; width: 180px; overflow: hidden;"-->
                                                                    <a class="unilinka" href="<?php base_url() ?>/services/<?=$item->alias?>.html">
                                                                        <h3 style="border-bottom: 2px solid darkgray; color: green; white-space: nowrap; width: 180px; overflow: hidden;" title="<?=strip_tags($item->title)?>">
