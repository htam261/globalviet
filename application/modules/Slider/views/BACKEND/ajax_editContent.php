...
<script type="text/javascript">
    ...
    function showResponse(responseText, statusText, xhr, $form) {
        if (responseText == 'success') {
            location.href = root + "admincp/" + ucfirst(module) + "/#/save";
        }
        ...
        <div class="row_text_field">
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    ...
                    <td class="right_text_field"><input value="<?php if (isset($result->name)) {
                            print $result->name;
                        } else {
                            print '';
        ...
        <div class="row_text_field">
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    ...
                    <td class="right_text_field"><input value="<?php if (isset($result->link)) {
                            print $result->link;
                        } else {
                            print '';
                        } ?>" type="text" name="linkAdmincp" id="linkAdmincp"/></td>
                </tr>
            </table>
        </div>
            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    ...
                    <td class="right_text_field"><input type="file"
                                                        name="fileAdmincp[thumbnail]"/><?php if (isset($result->image)) {
                            if ($result->image != '') { ?> - <a class="fancyboxClick"
                                                                href="<?= PATH_URL . DIR_UPLOAD_ADS . $result->image ?>">
                                    Review</a><?php }
                        } ?></td>
                </tr>
            </table>
                    ...
                    <td class="right_text_field">
                        <select name="positionAdmincp" id="positionAdmincp">
                            ...
                            foreach ($positions as $postion) { ?>
                                <option <?php if (isset($result->position)) if ($result->position == $postion->id) print "selected=\"selected\""; ?>
                                    value="<?= $postion->id ?>"><?= $postion->Name ?></option>
                            <?php } ?>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="right_text_field">
                        <select name="typeAdmincp" id="typeAdmincp">
                            <option <?php if (isset($result->type)) if ($result->type == 1) print "selected=\"selected\""; ?>
                                value="1">Image
                            </option>
                            <!--                            <option -->
                            <?php //if(isset($result->type)) if($result->type == 2) print "selected=\"selected\"";?><!-- value="2">swf</option>-->
                        </select>
                    </td>
                </tr>
