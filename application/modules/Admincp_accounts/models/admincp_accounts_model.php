<?php
class Admincp_accounts_model extends MY_Model {
	private $module = 'admincp_accounts';
	private $table = 'admin_users';

	function getsearchContent($limit,$page){
		$this->db->select($this->table.'.*, admin_groups.name as group_name');
		$this->db->join('admin_groups','admin_groups.id='.$this->table.'.group_id','LEFT');
