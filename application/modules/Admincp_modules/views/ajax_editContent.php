...
<div class="table">
	...
	<div class="row_text_field">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td class="left_text_field">Module name:</td>
				<td class="right_text_field"><input value="<?php if(isset($result->name)) { print $result->name; }else{ print '';} ?>" type="text" name="moduleNameAdmincp" /></td>
			</tr>
		</table>
	</div>
	</form>
