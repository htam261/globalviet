...
/*width: 1319px;*//*style="width: 1319px; height: 420px"*/
}
</style>
<div class="">
<div class="col-md-12 margin-top-30" >
    <div class="container bacground-map boder-radius-10 padding-left-right-0 height370">
                    ...
                    <ul class="list-inline text-right">
                     ...
                     <!--   <li class="">-->
                      ...
                      <!--  </li>
                        ...
                        <li>
                            <a href="<?php base_url() ?>/lien-he.html">CONTACT |</a>
                        </li>
                        <li class="dropdown">
        ...
        <div class="col-md-12" style="padding-left: 0px; padding-right: 0px; padding-top: 20px;">
            <hr width="60%" style="border-width: 1px; box-shadow: 0 0 5px #ffffff; border-style: solid; border-color: rgb(192, 192, 192); -moz-border-top-colors: none; -moz-border-right-colors: none; -moz-border-bottom-colors: none; -moz-border-left-colors: none; border-image: none; text-align: center; margin-left: auto; margin-right: auto;">
        </div>
    ...
    <div class="container boder-radius-10 padding-left-right-0">
        ...
        <div class="col-md-12 text-center">
            <p style="margin-bottom: 0px;">
                Add: 15 Dao Duy Anh Str., Ward 9, Phu Nhuan Dist., HCMC, Vietnam
            </p>
            <p>
                Tel: 08 38 449 888      -      Fax: 08 38 478 999
            </p>
