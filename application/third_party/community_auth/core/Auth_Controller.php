...
class Auth_Controller extends MX_Controller {
	...
	{//var_dump($this->authentication->user_status( $level ));exit();
	...
	{//var_dump("Auth_Controller.php");exit();
	...
	private function _set_user_variables()
	{
        ...
        $this->auth_fullname = $this->auth_data->fullname;
        ...
        $this->config->set_item( 'auth_fullname',  $this->auth_fullname );
